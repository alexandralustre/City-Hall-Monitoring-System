        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl bg-white p-6 shadow-sm border border-gray-200">
            ...
            <ol className="space-y-3 text-base text-gray-700 list-decimal list-inside">
              ...
              <li>
                Select the <strong>Requesting Department</strong> from the dropdown
              </li>
              <li>
              ...
              <li>
                Select the current <strong>Status</strong> (usually "Pending")
              </li>
              <li>
          ...
          <div className="rounded-xl bg-white p-6 shadow-sm border border-gray-200">
            ...
            <ul className="mt-4 space-y-2 text-base text-gray-700 list-disc list-inside">
              ...
              <li>
                <strong>DEPT</strong> = Department code (e.g., BUDG, TREAS)
              </li>
              <li>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-base text-gray-600">
                    Document is waiting for approval or processing
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-xl">✅</span>
                <div>
                  <strong className="text-base text-gray-900">Approved</strong>
                  <p className="text-base text-gray-600">
                    Document has been approved and can proceed
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-xl">📤</span>
                <div>
                  <strong className="text-base text-gray-900">Released</strong>
                  <p className="text-base text-gray-600">
                    Document has been released to the requesting department
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-base text-gray-900">Completed</strong>
                  <p className="text-base text-gray-600">
                    Document process is fully completed
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="rounded-xl bg-green-50 p-6 border-2 border-green-200">
            ...
            <ul className="space-y-2 text-base text-green-800 list-disc list-inside">
              ...
              <li>Select the correct department - this affects the document code</li>
